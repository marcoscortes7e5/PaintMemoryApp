...
class GameEasyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var gameEasyTurnTextView = findViewById<TextView>(R.id.gameEasyTurnTextView)
        gameEasyTurnTextView.text = ("Turno: 0")
        val gameEasyBackToMenuButton = findViewById<Button>(R.id.gameHardBackToMenuButton).setOnClickListener {
            val gameEasyBackToMenuIntent = Intent(this, MainActivity::class.java)
            startActivity(gameEasyBackToMenuIntent)
        }
        ...
        var counter = 0
        val listOfCards = listOf(Card(findViewById(R.id.gameHardCard1)),
        ...
        listOfCards.forEach { card ->
            card.imageView.setOnClickListener {
                ...
                isListFull(listOfPlayedCards, listOfCards, gameEasyTurnTextView)
            }
        }
    ...
    private fun isListFull(
        ...
        gameEasyTurnTextView: TextView
    ) {
        if (listOfPlayedCards.size == 2) {
            numberOfMoves++
            gameEasyTurnTextView.setText("Turno: $numberOfMoves")
            ...
            if (!card.imageView.isEnabled){
                ...
                if (numberOfDisabledCards == listOfCards.size){
                    ...
                    val pointsCountIntent = Intent(this, PointsCountActivity::class.java)
                        .putExtra("score", numberOfMoves).putExtra("difficulty", difficulty)
